...
let url = `https://65decd11ff5e305f32a07c2e.mockapi.io/user`;
let itemlist=document.getElementById('itemlist')

//Part 1: POSTING THE DATA TO THE SERVER
function submitBtn(){
    console.log(1)
...
//Part 4: EDIT BUTTON > DESIGN THE FORM > SHOULD HAVE THE SPECIFIC
...
async function updateUser(updateUserId){
    ...
    let updateUserName=document.getElementById('modadlusername'+updateUserId).value
    letupdateEmail=document.getElementById('modalemail'+updateUserId).value
